\section{Objet MÃ©tier Client}

\begin{description}
\item{SOMC1 Consultation Client}
\item{SOMC2 Consultation Liste des Client}

\item{SBC1 Consultation EntitÃ© Personne}
\item{SBC1 Consultation EntitÃ© Compte}
\end{description}

\subsection{SM1 Liste des comptes d'un Client}
\paragraph{SOM} SOMC1 : Consultation Client - SOMP1 : Consultation produit
\paragraph{EntrÃ©es} id client
\paragraph{Sorties} NomClient, Adr. Client
\paragraph{Description}
Consultation de l'ensemble des informations client et rÃ©cupÃ©ration du type de compte Ã  partir de sa fiche produit
